...
{
    public class CLS_DBREGISTROCURSOS_DAL
    {
        #region Variables globales...
        public const string BookName = "DB_REGISTROS";
        #endregion
        ...
        public CLS_DBREGISTROCURSOS_DAL()
        {
        ...
        #region Funciones...
        public EntityObjects.CLS_REGISTRO_info GetEntityObject(int Id, CLS_SqlCommandWithTransaction Trans = null)
        {
            try
            {
        ...
        public EntityObjects.CLS_REGISTRO_info GetEntityObject(DataRow EntityRow)
        {
            try
            {
                EntityObjects.CLS_REGISTRO_info EntityInfo = new EntityObjects.CLS_REGISTRO_info();
                if (EntityRow[EntityObjects.CLS_REGISTRO_info.FieldNames.Id] != DBNull.Value) EntityInfo.Id = Convert.ToInt32(EntityRow[EntityObjects.CLS_REGISTRO_info.FieldNames.Id]);
                if (EntityRow[EntityObjects.CLS_REGISTRO_info.FieldNames.nompart] != DBNull.Value) EntityInfo.nompart = Convert.ToString(EntityRow[EntityObjects.CLS_REGISTRO_info.FieldNames.nompart]);
                if (EntityRow[EntityObjects.CLS_REGISTRO_info.FieldNames.id_curso] != DBNull.Value) EntityInfo.id_curso = Convert.ToInt32(EntityRow[EntityObjects.CLS_REGISTRO_info.FieldNames.id_curso]);
                if (EntityRow[EntityObjects.CLS_REGISTRO_info.FieldNames.importe] != DBNull.Value) EntityInfo.importe = Convert.ToInt32(EntityRow[EntityObjects.CLS_REGISTRO_info.FieldNames.importe]);
                if (EntityRow[EntityObjects.CLS_REGISTRO_info.FieldNames.pago] != DBNull.Value) EntityInfo.pago = Convert.ToString(EntityRow[EntityObjects.CLS_REGISTRO_info.FieldNames.pago]);
                return EntityInfo;
            }
            catch (Exception ex)
            {
        ...
        private List<NASA.CONSOFT.CoreFoundation.Common.DataLayer.CLS_FieldValues> GetHeaderFieldValues(EntityObjects.CLS_REGISTRO_info EntityInfo)
        {
            try
            {
                ...
                FieldValues.Add(new NASA.CONSOFT.CoreFoundation.Common.DataLayer.CLS_FieldValues(EntityObjects.CLS_REGISTRO_info.FieldNames.nompart, string.IsNullOrWhiteSpace(EntityInfo.nompart) ? "" : EntityInfo.nompart.ToString(), NASA.CONSOFT.CoreFoundation.eBOOK.DataLayer.ModEnums.FieldType.Texto));
                FieldValues.Add(new NASA.CONSOFT.CoreFoundation.Common.DataLayer.CLS_FieldValues(EntityObjects.CLS_REGISTRO_info.FieldNames.id_curso, EntityInfo.id_curso.ToString(), NASA.CONSOFT.CoreFoundation.eBOOK.DataLayer.ModEnums.FieldType.Numero));
                FieldValues.Add(new NASA.CONSOFT.CoreFoundation.Common.DataLayer.CLS_FieldValues(EntityObjects.CLS_REGISTRO_info.FieldNames.importe, EntityInfo.importe.ToString(), NASA.CONSOFT.CoreFoundation.eBOOK.DataLayer.ModEnums.FieldType.Numero));
                FieldValues.Add(new NASA.CONSOFT.CoreFoundation.Common.DataLayer.CLS_FieldValues(EntityObjects.CLS_REGISTRO_info.FieldNames.pago, string.IsNullOrWhiteSpace(EntityInfo.pago) ? "" : EntityInfo.pago.ToString(), NASA.CONSOFT.CoreFoundation.eBOOK.DataLayer.ModEnums.FieldType.Texto));
                return FieldValues;
            }
            catch (Exception ex)
            {
        ...
        public int Insert(EntityObjects.CLS_REGISTRO_info EntityInfo, CLS_SqlCommandWithTransaction Transaction = null)
        {
            try
            {
        ...
        public int Update(EntityObjects.CLS_REGISTRO_info EntityInfo, CLS_SqlCommandWithTransaction Transaction = null)
        {
            try
            {
                List<NASA.CONSOFT.CoreFoundation.Common.DataLayer.CLS_FieldValues> FieldValues = GetHeaderFieldValues(EntityInfo);
        ...
        public int Delete(int Id)
        {
            try
            {
                List<NASA.CONSOFT.CoreFoundation.Common.DataLayer.CLS_FieldValues> FieldValues = new List<NASA.CONSOFT.CoreFoundation.Common.DataLayer.CLS_FieldValues>
                {
                    new NASA.CONSOFT.CoreFoundation.Common.DataLayer.CLS_FieldValues(EntityObjects.CLS_REGISTRO_info.FieldNames.Id, (-Id).ToString(), NASA.CONSOFT.CoreFoundation.eBOOK.DataLayer.ModEnums.FieldType.Numero)
                };
