...
{
    public class CLS_DBCATALOGOS_DAL
    {
        #region Variables globales...
        public const string BookName = "DB_CATALOGOS";
        #endregion
        ...
        #region Funciones...
        public EntityObjects.CLS_DBCATALOGOS_info GetEntityObject(int Id, CLS_SqlCommandWithTransaction Trans = null)
        {
            try
            {
        ...
        public EntityObjects.CLS_DBCATALOGOS_info GetEntityObject(DataRow EntityRow)
        {
            try
            {
                EntityObjects.CLS_DBCATALOGOS_info EntityInfo = new EntityObjects.CLS_DBCATALOGOS_info();
                if (EntityRow[EntityObjects.CLS_DBCATALOGOS_info.FieldNames.Id] != DBNull.Value) EntityInfo.Id = Convert.ToInt32(EntityRow[EntityObjects.CLS_DBCATALOGOS_info.FieldNames.Id]);
                if (EntityRow[EntityObjects.CLS_DBCATALOGOS_info.FieldNames.id_categoria] != DBNull.Value) EntityInfo.id_categoria = Convert.ToInt32(EntityRow[EntityObjects.CLS_DBCATALOGOS_info.FieldNames.id_categoria]);
                if (EntityRow[EntityObjects.CLS_DBCATALOGOS_info.FieldNames.nomcat] != DBNull.Value) EntityInfo.nomcat = Convert.ToString(EntityRow[EntityObjects.CLS_DBCATALOGOS_info.FieldNames.nomcat]);
                return EntityInfo;
            }
            catch (Exception ex)
            {
        ...
        private List<NASA.CONSOFT.CoreFoundation.Common.DataLayer.CLS_FieldValues> GetHeaderFieldValues(EntityObjects.CLS_DBCATALOGOS_info EntityInfo)
        {
            try
            {
                ...
                FieldValues.Add(new NASA.CONSOFT.CoreFoundation.Common.DataLayer.CLS_FieldValues(EntityObjects.CLS_DBCATALOGOS_info.FieldNames.id_categoria, EntityInfo.id_categoria.ToString(), NASA.CONSOFT.CoreFoundation.eBOOK.DataLayer.ModEnums.FieldType.Numero));
                FieldValues.Add(new NASA.CONSOFT.CoreFoundation.Common.DataLayer.CLS_FieldValues(EntityObjects.CLS_DBCATALOGOS_info.FieldNames.nomcat, string.IsNullOrWhiteSpace(EntityInfo.nomcat) ? "" : EntityInfo.nomcat.ToString(), NASA.CONSOFT.CoreFoundation.eBOOK.DataLayer.ModEnums.FieldType.Texto));
                return FieldValues;
            }
            catch (Exception ex)
            {
        ...
        public int Insert(EntityObjects.CLS_DBCATALOGOS_info EntityInfo, CLS_SqlCommandWithTransaction Transaction = null)
        {
            try
            {
        ...
        public int Update(EntityObjects.CLS_DBCATALOGOS_info EntityInfo, CLS_SqlCommandWithTransaction Transaction = null)
        {
            try
            {
                List<NASA.CONSOFT.CoreFoundation.Common.DataLayer.CLS_FieldValues> FieldValues = GetHeaderFieldValues(EntityInfo);
        ...
        public int Delete(int Id)
        {
            try
            {
                List<NASA.CONSOFT.CoreFoundation.Common.DataLayer.CLS_FieldValues> FieldValues = new List<NASA.CONSOFT.CoreFoundation.Common.DataLayer.CLS_FieldValues>
                {
                    new NASA.CONSOFT.CoreFoundation.Common.DataLayer.CLS_FieldValues(EntityObjects.CLS_DBCATALOGOS_info.FieldNames.Id, (-Id).ToString(), NASA.CONSOFT.CoreFoundation.eBOOK.DataLayer.ModEnums.FieldType.Numero)
                };
