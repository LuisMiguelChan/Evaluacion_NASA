...
{
    public class CLS_DBCATALOGOS_BAL
    {
        #region Variables globales...
        public const string BookName = DataLayer.CLS_DBCATALOGOS_DAL.BookName;
        public string TemplateVersion = "1.0.0.0";
        public DataLayer.CLS_DBCATALOGOS_DAL CONFIDal = new DataLayer.CLS_DBCATALOGOS_DAL();
        public const string viewCONFI = "View_Catalogos";
        public const string Subset_Catalogos = "Subset_Catalogos";
        #endregion
        ...
        public NASA.CONSOFT.CoreFoundation.eBOOK.BusinessLayer.CLS_Template_Field_Collection GetTemplateFieldCollection()
        {
            try
            {
                ...
                Field = new NASA.CONSOFT.CoreFoundation.eBook.BusinessLayer.CLS_Template_Fields
                {
                    ...
                    FieldName = EntityObjects.CLS_DBCATALOGOS_info.FieldNames.id_categoria,
                ...
                Field = new NASA.CONSOFT.CoreFoundation.eBook.BusinessLayer.CLS_Template_Fields
                {
                    ...
                    FieldName = EntityObjects.CLS_DBCATALOGOS_info.FieldNames.nomcat,
        ...
        public NASA.CONSOFT.CoreFoundation.eBook.EntityObjects.InternalBooks.CLS_SubsetInfo GetOrCreateSubset()
        {
            try
            {
                ...
                NASA.CONSOFT.CoreFoundation.eBook.EntityObjects.InternalBooks.CLS_SubsetInfo SubsetInfo = SubsetBAL.GetSubSetConfiguration(Subset_Catalogos);
                ...
                else
                {
                    ...
                    int BookId = BookBAL.GetId(Evaluacion_NASACore.BusinessLayer.CLS_DBCATALOGOS_BAL.BookName);
                    if (BookId > 0)
                    {
        ...
        public EntityObjects.CLS_DBCATALOGOS_info GetEntityObject(int Id, NASA.PROCNASA.DataAccess.CLS_SqlCommandWithTransaction Transaction = null)
        {
        ...
        public int Save(EntityObjects.CLS_DBCATALOGOS_info EntityInfo, NASA.PROCNASA.DataAccess.CLS_SqlCommandWithTransaction transaction = null)
        {
            try
            {
                if (EntityInfo.Id > 0)
        ...
        public EntityObjects.CLS_DBCATALOGOS_info GetConfiConfig(NASA.PROCNASA.DataAccess.CLS_SqlCommandWithTransaction Transaction = null)
        {
