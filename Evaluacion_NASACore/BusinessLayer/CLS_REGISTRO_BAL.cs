...
{
    public class CLS_REGISTRO_BAL
    {
        #region Variables globales...
        public const string BookName = DataLayer.CLS_DBREGISTROCURSOS_DAL.BookName;
        public string TemplateVersion = "1.0.0.0";
        public DataLayer.CLS_DBREGISTROCURSOS_DAL CONFIDal = new DataLayer.CLS_DBREGISTROCURSOS_DAL();
        public const string viewCONFI = "View_Registro";
        public const string Subset_Registros = "Subset_Registros";
        #endregion
        ...
        public NASA.CONSOFT.CoreFoundation.eBOOK.BusinessLayer.CLS_Template_Field_Collection GetTemplateFieldCollection()
        {
            try
            {
                ...
                Field = new NASA.CONSOFT.CoreFoundation.eBook.BusinessLayer.CLS_Template_Fields
                {
                    ...
                    FieldName = EntityObjects.CLS_REGISTRO_info.FieldNames.nompart,
                    Description = "Nombre Participante",
                    Documentation = "",
                    Coord_X = 10,
                    Coord_Y = 5,
                    Length = 300,
                ...
                Field = new NASA.CONSOFT.CoreFoundation.eBook.BusinessLayer.CLS_Template_Fields
                {
                    ...
                    FieldName = EntityObjects.CLS_REGISTRO_info.FieldNames.id_curso,
                ...
                Field = new NASA.CONSOFT.CoreFoundation.eBook.BusinessLayer.CLS_Template_Fields
                {
                    SectionType = NASA.CONSOFT.CoreFoundation.eBook.BusinessLayer.CLS_SECTION_TYPES.HEADER[0],
                    FieldType = NASA.CONSOFT.CoreFoundation.eBook.BusinessLayer.CLS_FIELD_TYPES.NUMERO,
                    FieldName = EntityObjects.CLS_REGISTRO_info.FieldNames.importe,
                    Description = "Importe",
                    Documentation = "",
                    Coord_X = 10,
                    Coord_Y = Fields.get_Item(Fields.Count - 1).Coord_Y + 21,
                ...
                {
                    SectionType = NASA.CONSOFT.CoreFoundation.eBook.BusinessLayer.CLS_SECTION_TYPES.HEADER[0],
                    FieldType = NASA.CONSOFT.CoreFoundation.eBook.BusinessLayer.CLS_FIELD_TYPES.ARCHIVO,
                    FieldName = EntityObjects.CLS_REGISTRO_info.FieldNames.pago,
                    Description = "pago",
                    Documentation = "",
                    Coord_X = 10,
                    Coord_Y = Fields.get_Item(Fields.Count - 1).Coord_Y + 21,
        ...
        public NASA.CONSOFT.CoreFoundation.eBook.EntityObjects.InternalBooks.CLS_SubsetInfo GetOrCreateSubset()
        {
            try
            {
                ...
                NASA.CONSOFT.CoreFoundation.eBook.EntityObjects.InternalBooks.CLS_SubsetInfo SubsetInfo = SubsetBAL.GetSubSetConfiguration(Subset_Registros);
                ...
                else
                {
                    ...
                    int BookId = BookBAL.GetId(Evaluacion_NASACore.BusinessLayer.CLS_REGISTRO_BAL.BookName);
                    if (BookId > 0)
                    {
        ...
        public EntityObjects.CLS_REGISTRO_info GetEntityObject(int Id, NASA.PROCNASA.DataAccess.CLS_SqlCommandWithTransaction Transaction = null)
        {
        ...
        public int Save(EntityObjects.CLS_REGISTRO_info EntityInfo, NASA.PROCNASA.DataAccess.CLS_SqlCommandWithTransaction transaction = null)
        {
            try
            {
                if (EntityInfo.Id > 0)
        ...
        public EntityObjects.CLS_REGISTRO_info GetConfiConfig(NASA.PROCNASA.DataAccess.CLS_SqlCommandWithTransaction Transaction = null)
        {
